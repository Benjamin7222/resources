...
local kickMenu = MenuV:CreateMenu(false, Lang:t('menu.kick'), menuLocation, 220, 20, 60, menuSize, 'qbcore', 'menuv', 'test6')
local permMenu = MenuV:CreateMenu(false, Lang:t('menu.permissions'), menuLocation, 220, 20, 60, menuSize, 'qbcore', 'menuv', 'test7')
local banMenu = MenuV:CreateMenu(false, Lang:t('menu.ban'), menuLocation, 220, 20, 60, menuSize, 'qbcore', 'menuv', 'test8')
		...
		if hasperms then
			...
			permMenu:AddSlider({
				...
				change = function(item, newValue, oldValue)
					...
					if vcal == 1 then
						selectedgroup = {}
						selectedgroup[#selectedgroup + 1] = {rank = 'user', label = 'Utilisateur'}
					elseif vcal == 2 then
						selectedgroup = {}
			...
			permMenu:AddButton({
				label = Lang:t('info.confirm'),
				value = 'giveperms',
				description = 'Attribuer le groupe de permissions',
				select = function(btn)
