...
CreateThread(function()
    for clothing, v in pairs(Config.Stores) do
        exports['qbr-core']:createPrompt(v.location..'-clothing', v.coords, 0xF3830D8E, 'Ouvrir : ' .. v.name, { -- [J]
			type = 'client',
			event = 'qbr-clothing:client:openMenu',
			args = {false, 'clothingMenu'}
        })
		exports['qbr-core']:createPrompt(v.location..'-outfits', v.coords, 0xC7B5340A, 'Ouvrir les tenues', { -- ["ENTER"]
            type = 'client',
            event = 'qbr-clothing:client:openMenu',
