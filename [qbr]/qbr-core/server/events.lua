...
local function IsPlayerBanned(plicense)
    ...
    if os.time() < result.expire then
        ...
        return true, 'Vous avez été banni du serveur :\n' .. result.reason .. '\nVotre bannissement expire le ' .. timeTable.day .. '/' .. timeTable.month .. '/' .. timeTable.year .. ' ' .. timeTable.hour .. ':' .. timeTable.min .. '\n'
    else
...
-- Server side only: no client uses it, and as a net event any player could give himself any item (with any info)
