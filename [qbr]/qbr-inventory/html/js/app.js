...
function FormatAttachmentInfo(data) {
    $.post(
        ...
        function (data) {
            ...
            $(".weapon-attachments-container-details").html('<span style="font-weight: bold; letter-spacing: .1vh;">Numéro de série</span><br> ' + ClickedItemData.info.serie + '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Durabilité - ' + Durability.toFixed() + '% </span> <div class="weapon-attachments-container-detail-durability"><div class="weapon-attachments-container-detail-durability-total"></div></div>');
            ...
            if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
                if (data.AttachmentData.length > 0) {
                    $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Accessoires</span>');
                    ...
                    $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Cette arme n\'a pas d\'accessoires</span>');
                }
            } else {
                $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Cette arme n\'a pas d\'accessoires</span>');
            }
...
function getGender(info) {
    return info.gender === 1 ? "Femme" : "Homme";
}

// Text typed by players (newspaper titles...) must never be injected as raw html
...
function generateDescription(itemData) {
    if (itemData.type === "weapon") {
        ...
        return `<p><strong>Numéro de série : </strong><span>${itemData.info.serie}</span></p>
                    <p><strong>Munitions : </strong><span>${ammo}</span></p>
                    <p>${itemData.description}</p>`;
    }
    switch (itemData.name) {
        case "id_card":
            return `<p><strong>N° citoyen : </strong><span>${itemData.info.citizenid}</span></p>
              <p><strong>Prénom : </strong><span>${itemData.info.firstname}</span></p>
              <p><strong>Nom : </strong><span>${itemData.info.lastname}</span></p>
              <p><strong>Date de naissance : </strong><span>${itemData.info.birthdate}</span></p>
              <p><strong>Sexe : </strong><span>${getGender(itemData.info)}</span></p>
              <p><strong>Nationalité : </strong><span>${itemData.info.nationality}</span></p>`;
        case "driver_license":
            return `<p><strong>Prénom : </strong><span>${itemData.info.firstname}</span></p>
            <p><strong>Nom : </strong><span>${itemData.info.lastname}</span></p>
            <p><strong>Date de naissance : </strong><span>${itemData.info.birthdate}</span>
            </p><p><strong>Permis : </strong><span>${itemData.info.type}</span></p>`;
        case "weaponlicense":
            return `<p><strong>Prénom : </strong><span>${itemData.info.firstname}</span></p>`;
        case "lawyerpass":
            return `<p><strong>N° de laissez-passer : </strong><span>${itemData.info.id}</span></p>
            <p><strong>Prénom : </strong><span>${itemData.info.firstname}</span></p>
            <p><strong>Nom : </strong><span>${itemData.info.lastname}</span></p>
            <p><strong>N° citoyen : </strong><span>${itemData.info.citizenid}</span></p>`;
        case "harness":
            return `<p>${itemData.info.uses} utilisations restantes</p>`;
        case "filled_evidence_bag":
            if (itemData.info.type == "casing") {
                return `<p><strong>Type de preuve : </strong><span>${itemData.info.label}</span></p>
                <p><strong>Numéro de type : </strong><span>${itemData.info.ammotype}</span></p>
                <p><strong>Calibre : </strong><span>${itemData.info.ammolabel}</span></p>
                <p><strong>Numéro de série : </strong><span>${itemData.info.serie}</span></p>
                <p><strong>Scène de crime : </strong><span>${itemData.info.street}</span></p><br /><p>${itemData.description}</p>`;
            } else if (itemData.info.type == "blood") {
                return `<p><strong>Type de preuve : </strong><span>${itemData.info.label}</span></p>
                <p><strong>Groupe sanguin : </strong><span>${itemData.info.bloodtype}</span></p>
                <p><strong>Code ADN : </strong><span>${itemData.info.dnalabel}</span></p>
                <p><strong>Scène de crime : </strong><span>${itemData.info.street}</span></p><br /><p>${itemData.description}</p>`;
            } else if (itemData.info.type == "fingerprint") {
                return `<p><strong>Type de preuve : </strong><span>${itemData.info.label}</span></p>
                <p><strong>Empreinte : </strong><span>${itemData.info.fingerprint}</span></p>
                <p><strong>Scène de crime : </strong><span>${itemData.info.street}</span></p><br /><p>${itemData.description}</p>`;
            } else if (itemData.info.type == "dna") {
                return `<p><strong>Type de preuve : </strong><span>${itemData.info.label}</span></p>
                <p><strong>Code ADN : </strong><span>${itemData.info.dnalabel}</span></p><br /><p>${itemData.description}</p>`;
            }
        case "stickynote":
            return `<p>${itemData.info.label}</p>`;
        case "moneybag":
            return `<p><strong>Montant en espèces : </strong><span>$${itemData.info.cash}</span></p>`;
        case "markedbills":
            return `<p><strong>Valeur : </strong><span>$${itemData.info.worth}</span></p>`;
        case "visa":
            return `<p><strong>Titulaire : </strong><span>${itemData.info.name}</span></p>`;
        case "mastercard":
            return `<p><strong>Titulaire : </strong><span>${itemData.info.name}</span></p>`;
        case "labkey":
            return `<p>Labo : ${itemData.info.lab}</p>`;
        case "journal":
        case "journal2":
            return `<p><strong>Journal: </strong><span>${escapeHtml(itemData.info.title)}</span></p>
            <p><strong>Édition n°: </strong><span>${escapeHtml(itemData.info.edition)}</span></p>
            <p><strong>Rédigé par: </strong><span>${escapeHtml(itemData.info.author)}</span></p>`;
        case "newspaper_bundle":
            return `<p><strong>Journal: </strong><span>${escapeHtml(itemData.info.title)}</span></p>
            <p><strong>Édition n°: </strong><span>${escapeHtml(itemData.info.edition)}</span></p>
            <p><strong>Exemplaires: </strong><span>${escapeHtml(itemData.info.count)}</span></p>`;
        default:
        ...
        if ((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            if (fromData.amount == $toAmount) {
                ...
                if (toData != undefined && toData.combinable != null && isItemAllowed(fromData.name, toData.combinable.accept)) {
                    $.post("https://qbr-inventory/getCombineItem", JSON.stringify({ item: toData.combinable.reward }), function (item) {
                        $(".combine-option-text").html("<p>En combinant ces objets vous obtenez : <b>" + item.label + "</b></p>");
                    });
...
(() => {
    ...
    Inventory.UpdateMoney = function (money) {
        const format = function (value) {
            const amount = Number(value);
            return (Number.isFinite(amount) ? amount : 0).toLocaleString("fr-FR", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
            }) + " $";
        };
        money = money || {};
        $("#inventory-cash").text(format(money.cash));
        $("#inventory-bank").text(format(money.bank));
    };

    Inventory.Open = function (data) {
        Inventory.UpdateMoney(data.money);
        totalWeight = 0;
        totalWeightOther = 0;
        ...
        if (data.toggle) {
            if (!requiredItemOpen) {
                ...
                $.each(data.items, function (index, item) {
                    var element = `<div class="item-slot requiredItem-box"><div class="item-slot-amount"><p>Requis</p></div><div class="item-slot-img"><img src="images/${item.image}" alt="${item.name}" /></div><div class="item-slot-label"><p>${item.label}</p></div></div>`;
                    $(".requiredItem-container").hide();
        ...
        window.addEventListener("message", function (event) {
            switch (event.data.action) {
                ...
                case "update":
                    ...
                    break;
                case "money":
                    Inventory.UpdateMoney(event.data.money);
                    break;
                case "itemBox":
