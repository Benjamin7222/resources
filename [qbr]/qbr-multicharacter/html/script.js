    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                var originalText = "Récupération des données du joueur";
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        ...
                        loadingProgress = 0;
                        originalText = "Récupération des données";
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">Cet emplacement n\'est pas encore utilisé.<br><br>Ce personnage n\'a pas encore d\'informations.</span>');
    } else {
        var gender = "Homme"
...
function setCharactersList() {
    var htmlResult = '<div class="character-list-header"><p>Mes personnages</p></div>'
    ...
    htmlResult += '<div class="character-btn" id="play"><p id="play-text">Sélectionnez un personnage</p></div><div class="character-btn" id="delete"><p id="delete-text">Sélectionnez un personnage</p></div>'
