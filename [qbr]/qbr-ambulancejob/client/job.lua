...
function createAmbuPrompts()
    for k, v in pairs(Config.Locations["armory"]) do
        exports['qbr-core']:createPrompt("ambulance:armory:"..k, vector3(v.x, v.y, v.z), Config.PromptKey, Lang:t('text.armory'), {
            type = 'client',
            event = 'ambulance:client:promptArmory',
        })
    end
    for k, v in pairs(Config.Locations["duty"]) do
        exports['qbr-core']:createPrompt("ambulance:duty:"..k, vector3(v.x, v.y, v.z), Config.PromptKey, Lang:t('text.duty'), {
            type = 'client',
            event = 'ambulance:client:promptDuty',
        })
    end
    for k, v in pairs(Config.Locations["vehicle"]) do
        exports['qbr-core']:createPrompt("ambulance:vehicle:"..k, vector3(v.x, v.y, v.z), Config.PromptKey, Lang:t('text.garage'), {
            type = 'client',
    ...
    for k, v in pairs(Config.Locations["stash"]) do
        exports['qbr-core']:createPrompt("ambulance:stash:"..k, vector3(v.x, v.y, v.z), Config.PromptKey, Lang:t('text.pstash'), {
            type = 'client',
            event = 'ambulance:client:promptStash',
        })
    end
    for k, v in pairs(Config.Locations["checking"]) do
        exports['qbr-core']:createPrompt("ambulance:checkin:"..k, vector3(v.x, v.y, v.z), Config.PromptKey, Lang:t('text.check_in'), {
            type = 'client',
