...
Config.BankLocations = {
    ...
    {name = 'Banque nationale du Lemoyne',    bankType = "BANKS2",    coords = vector3(2644.579, -1292.313, 52.24956),    showblip = true},
    {name = 'Caisse d\'épargne de Valentine',   bankType = "BANKS3",    coords = vector3(-308.4189, 775.8842, 118.7017),    showblip = true},
    {name = 'Première banque nationale',      bankType = "BANKS4",    coords = vector3(-813.1633, -1277.486, 43.63771),   showblip = true},
}
