...
function setupLocations(locations, myHouses, isNew) {
    ...
    $(parent).html("");
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Où souhaitez-vous commencer ?"><p><span id="null">Où souhaitez-vous commencer ?</span></p></div>')

    setTimeout(function() {
        if (!isNew){
            $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Dernière position"><p><span id="current-location">Dernière position</span></p></div>');
        }
