...
Config.Language = {
    ...
    err = "\xE2\x9D\x97[File] Une erreur est survenue",
    ...
    timedout = "\xE2\x9D\x97[File] Erreur : délai dépassé ?",
    wlonly = "\xE2\x9D\x97[File] Vous devez être sur liste blanche pour rejoindre ce serveur",
    steam = "\xE2\x9D\x97 [File] Erreur : Steam doit être lancé"
}
